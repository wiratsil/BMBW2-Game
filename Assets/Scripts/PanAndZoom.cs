...
public class PanAndZoom : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        StartCoroutine(SetBoundY());
    }

    IEnumerator SetBoundY()
    {
        yield return new WaitForEndOfFrame();

        Vector3 boundPos = cam.ViewportToWorldPoint(new Vector3(0, 0, 0));
        boundMaxY = Mathf.Abs(boundPos.y);
        boundMinY = boundPos.y;
    }
